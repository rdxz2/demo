...
CDC__STREAM_FILEWRITER_ALL_FILE_MAX_OPENED_TIME_S = int(os.environ['CDC__STREAM_FILEWRITER_ALL_FILE_MAX_OPENED_TIME_S'])
CDC__STREAM_FILEWRITER_NO_MESSAGE_WAIT_TIME_S = int(os.environ['CDC__STREAM_FILEWRITER_NO_MESSAGE_WAIT_TIME_S'])
...
CDC__VALIDATION_INITIAL_ROUND_PRECISION = int(os.environ['CDC__VALIDATION_INITIAL_ROUND_PRECISION'])
